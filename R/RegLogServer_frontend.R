...
#'             RegLog_txt(lang = private$lang, custom_txts = private$custom_txts, x ="register_ui_3")),
...
#'             label = RegLog_txt(lang = private$lang, custom_txts = private$custom_txts, x = "password_new")),
#'           newpass2_input = passwordInput(
...
RegLogServer_frontend <- function(
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      observe(
        self$UI_list_resetPass <- list(
          title = h2(RegLog_txt(lang = private$lang, custom_txts = private$custom_txts, x ="reset_ui_1")),
          desc1 = p(RegLog_txt(lang = private$lang, custom_txts = private$custom_txts, x ="reset_ui_2")),
          user_ID = textInput(
            session$ns("reset_user_ID"),
            label = RegLog_txt(lang = private$lang, custom_txts = private$custom_txts, x ="user_id")
